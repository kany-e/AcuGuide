...
struct Acupoint: Identifiable, Hashable {
    ...
    static let findGuide: [String: (findEn: String, feelEn: String, findZh: String, feelZh: String)] = [
        "TE2": ("Back of the hand up. Find the web between your ring and little fingers, then slide just behind it toward the wrist — you land in a soft dip where the two fingers part.",
                ...
                "指蹼后方那个略酸的软凹陷，摸到了吗？"),
        "HT8": ("Palm up. Make a loose fist — where the tip of your little finger touches the palm is the spot, between the fourth and fifth hand bones.",
                "The soft hollow your little fingertip lands on?",
                "掌心向上。轻轻握拳，小指指尖点到掌心的位置就是它，在第四、五掌骨之间。",
                "小指指尖落到的那个柔软凹陷？"),
        "LU10": ("Palm up. Follow the fleshy mound at the base of your thumb to its midpoint, right where the pale palm skin meets the back-of-hand skin.",
                "The tender middle of the thumb mound, on the colour border?",
                "掌心向上。沿拇指根部的隆起（鱼际）找到中点，正在手掌与手背肤色交界处。",
                "鱼际隆起中段、肤色交界上的酸胀点？"),
        "LU9": ("Palm up. At the thumb side of the wrist crease you can feel a pulse — the point sits in the small hollow right beside it, toward the thumb. Rest on the hollow, not on the pulse.",
                "The small hollow beside the pulse?",
                "掌心向上。腕横纹拇指侧能摸到脉搏，穴位就在脉搏旁靠拇指的小凹陷里 — 按在凹陷上，不要压住脉搏。",
                "脉搏旁边那个小凹陷？"),
        "LI5": ("Lift your thumb as if hitchhiking. Two tendons stand up at its base — the point is in the hollow between them at the wrist crease.",
                "The triangular hollow between the two tendons?",
                "拇指翘起（像竖大拇指）。拇指根部会绷起两条筋，穴位在两筋之间、靠近腕横纹的凹窝里。",
                "两筋之间那个三角形凹窝？"),
        "SI4": ("Back of the hand up, little-finger side. Slide from the base of the little-finger hand bone toward the wrist — you drop into a dip just before the wrist bone.",
                "The dip on the edge of the hand, just before the wrist?",
                "手背朝上，看小指侧。从第五掌骨底向手腕方向滑，快到腕骨时会落进一个凹陷。",
                "手掌外缘、腕骨前方的凹陷？"),
        "GV20": ("Run a finger up from the top of each ear until the two lines meet on the crown — the point is where they meet, in a slight dip on the midline.",
                "The slight dip at the very top of the head?",
                "从两侧耳尖向上摸，两条线在头顶正中相交处就是它，正中线上略有凹陷。",
                "头顶正中那个略凹的位置？"),
        "CV17": ("On the breastbone, midway between the nipples, on the centre line — a flat spot on the bone rather than on soft tissue.",
                "A slightly tender spot on the breastbone centre line?",
                "在胸骨上，两乳头连线的中点，正中线上 — 是骨面上的平坦点，不在软组织上。",
                "胸骨正中那个略酸的点？"),
        "KI27": ("Find your collarbone and slide along its lower edge toward the centre; stop about two thumb-widths out from the midline, in the hollow under the bone.",
                "The hollow just under the collarbone?",
                "沿锁骨下缘向胸骨中线滑，停在离中线约两个拇指宽处，锁骨下方的凹陷里。",
                "锁骨下缘的那个凹陷？"),
        "CV12": ("On the centre line of your upper belly, midway between your navel and the lower tip of the breastbone.",
                "The soft midpoint between navel and breastbone?",
                "在上腹正中线上，肚脐与胸骨下端的正中间。",
                "肚脐与胸骨下端正中那个柔软的位置？"),
        "ST25": ("Two thumb-widths out to the side from the centre of your navel, level with it.",
                "Level with the navel, a couple of thumb-widths out?",
                "从肚脐中心向两侧各量约两个拇指宽，与肚脐齐平。",
                "与肚脐齐平、旁开约两拇指宽的位置？"),
        "LI11": ("Bend your elbow to a right angle. The crease ends on the thumb side — the point sits in the dip right at that outer end.",
                "The dip at the outer end of the elbow crease?",
                "屈肘成直角。肘横纹在拇指侧到头，穴位就在横纹外侧尽头的凹陷处。",
                "肘横纹外端那个凹陷？"),
        "LU5": ("Palm up, elbow slightly bent. Feel the big tendon in the middle of the elbow crease — the point is in the dip just to the thumb side of it.",
                "The dip beside the tendon, on the thumb side?",
                "掌心向上，微屈肘。摸到肘横纹中央的大筋，穴位在其拇指侧的凹陷里。",
                "大筋拇指侧的凹陷？"),
        "ST36": ("Sit with the knee bent. Lay four fingers together below the outer dip of your kneecap — at the lowest finger, move one finger-width out from the shin crest onto the muscle.",
                "A firm, slightly sore spot on the muscle beside the shin bone?",
                "屈膝而坐。四指并拢放在膝眼下方，在第四指下缘、距胫骨前嵴外侧约一横指的肌肉上。",
                "胫骨旁肌肉上那个略酸的结实点？"),
        "GB34": ("Sit with the knee bent. Feel the small round bone bump on the outer lower leg just below the knee — the point is in the dip just in front of and below it.",
                "The dip below the round bone bump?",
                "屈膝而坐。摸到小腿外侧膝下的圆形骨突，穴位在其前下方的凹陷中。",
                "骨突前下方的凹陷？"),
        "SP10": ("Sit with the knee bent. Cup your opposite palm over the kneecap, fingers up the thigh — the point is under your thumb, on the bulge of the inner thigh muscle.",
                "The tender bulge of muscle above the inner knee?",
                "屈膝而坐。用对侧手掌盖住膝盖、手指朝大腿方向，拇指所指处即是，在大腿内侧肌肉隆起上。",
                "膝内上方肌肉隆起处的酸胀点？"),
        "ST34": ("Sit with the knee bent. About two thumb-widths above the outer top corner of the kneecap, in the dip on the outer thigh muscle.",
                "A firm dip above the outer corner of the kneecap?",
                "屈膝而坐。在髌骨外上角上方约两个拇指宽处，大腿外侧肌肉的凹陷中。",
                "髌骨外上角上方的结实凹陷？"),
        "ST35": ("Bend the knee. Two dimples appear under the kneecap, either side of the tendon — the point is the outer one.",
                "The outer dimple under the kneecap?",
                "屈膝。髌骨下方、髌韧带两侧会出现两个凹陷（膝眼），穴位是外侧那个。",
                "髌骨下方外侧的那个凹陷？"),
        "LR3": ("Top of the foot. Slide a fingertip back along the groove between your big toe and second toe — the point is where the two foot bones meet and your finger stops. Rest gently; a pulse can sometimes be felt here.",
                "The hollow where the two foot bones meet?",
                "足背。沿拇趾与第二趾之间的缝向脚踝方向滑，手指停在两骨相接处的凹陷里。此处有时能摸到脉搏，请轻按。",
                "两骨相接处的那个凹陷？"),
        "ST44": ("Top of the foot. Find the web between your second and third toes and slide just behind it into the small dip.",
                "The small dip just behind the toe web?",
                "足背。找到第二、三趾之间的趾蹼，向后滑一点，落进小凹陷。",
                "趾蹼后方的小凹陷？"),
        "KI1": ("Sole of the foot. Curl your toes — the deepest hollow that appears in the front third of the sole is the spot.",
                "The deepest hollow when you curl your toes?",
                "足底。蜷起脚趾，足底前三分之一处出现的最深凹陷就是它。",
                "蜷趾时足底最深的那个凹陷？"),
        "KI3": ("Inner ankle. Feel the tip of the inner ankle bone, then slide straight back toward the Achilles tendon — the point is in the hollow between them, level with the bone tip.",
                "The hollow between ankle bone and tendon?",
                "内踝。摸到内踝尖，向跟腱方向平移，穴位在内踝尖与跟腱之间的凹陷中，与踝尖齐平。",
                "内踝与跟腱之间的凹陷？"),
