...
export const MERIDIANS = [
  { id: 'lung',    zh: '手太阴肺经',   en: 'Lung',            ab: 'LU',
    descZh: '起于胸中，沿手臂内侧前缘下行至拇指。传统中医将其与肺及呼吸相联系，沿经穴位传统上用于调理咳嗽、气喘与咽喉不适。',
    descEn: 'Runs from the chest along the inner edge of the arm to the thumb. In traditional Chinese medicine it is associated with the lungs and breathing; its points are traditionally used for cough, wheezing, and throat discomfort.' },
  { id: 'li',      zh: '手阳明大肠经', en: 'Large Intestine', ab: 'LI',
    descZh: '起于食指，沿手臂外侧上行至面部。传统上与大肠相关，其穴位常用于面部、牙齿及肠胃方面的调理。',
    descEn: 'Travels from the index finger up the outer arm to the face. Traditionally linked to the large intestine; its points are classically used for facial, dental, and digestive concerns.' },
...
export const S = {
  ...
  subtitle: { zh: 'TCN Coach', en: '诗词山河 · 经络图谱' },
