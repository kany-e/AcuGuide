            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    row("cpu", AppLocale.pick("AI 也在设备上", "The AI runs on-device too"),
                        AppLocale.pick("AI 教练的自由问答由 Apple 的设备端模型生成（仅在支持的设备上），不联网。",
                                       "Free-form Coach AI answers are generated by Apple's on-device model (on supported devices) — no network involved."))
