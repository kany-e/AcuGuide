        ...
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    row("mic", AppLocale.pick("语音控制（可选）", "Voice control (optional)"),
                        AppLocale.pick("「语音控制」的几句短指令（确认位置、定住画面、继续）靠的是 Apple 的语音识别。如果你的语言有设备端识别，语音就留在设备上；否则这些短语会交给 Apple 的语音服务处理。默认关闭 — 你也可以随时改用点按。",
