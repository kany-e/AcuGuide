    ...
    var body: some View {
        ...
        default:
            prompt(
                ...
                text: AppLocale.pick(
                    "在系统设置中允许 AcuGuide 使用相机后，即可使用相机引导。图谱与 AI 教练无需相机。",
                    "Allow AcuGuide to use the camera in Settings to use the camera coach. The atlas and Coach AI work without it."),
